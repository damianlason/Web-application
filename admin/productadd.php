            ...
            <form action="" method="post" enctype="multipart/form-data">
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="productName" placeholder="Wprowadź nazwę produktu" class="medium" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="price" placeholder="Wprowadź cene..." class="medium" />
                        </td>
                    </tr>
